...
public class NetworkCharacterControllerPrototypeCustom : NetworkTransform {
  ...
  public float viewUpDownRotationSpeed = 50.0f ; // è„â∫Çå©ÇÈë¨ìx
  ...
  public virtual void Move(Vector3 direction) {
    ...
    if (direction == default) {
      ...
      //transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.LookRotation(direction), rotationSpeed * Runner.DeltaTime); // ÉLÉÉÉâÇÃå¸Ç´ÇÉJÉÅÉâÇÃå¸Ç´Ç…çáÇÌÇπÇÈ
    }
